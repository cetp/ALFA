...
#'
#' @examples
#' img <- ALFA_example("prepared2/img1.jpg")
#' input_dir <- ALFA_example("prepared2")
#'
#' output_dir <- ALFA_example("processed2")
#'
#'
...
#' \dontrun{
#' assess(source = img, output_dir = output_dir, res = 400, combine = FALSE)
#' }
