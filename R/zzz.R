...
.onLoad <- function(libname, pkgname) {
  ...
  # 
  # virtualenv_create('ALFA')
  # 
  # virtualenv_install("scipy", envname = 'ALFA')
  # virtualenv_install("argparse", envname = 'ALFA')
  # virtualenv_install("multiprocessing", envname = 'ALFA')
  # virtualenv_install("opencv-python", envname = 'ALFA')
  # virtualenv_install("exif", envname = 'ALFA')
  # virtualenv_install("pandas", envname = 'ALFA')
  # virtualenv_install("scikit-image", envname = 'ALFA')
  # virtualenv_install("piexif", envname = 'ALFA')
  reticulate::configure_environment(pkgname)
  source_python("inst/ALFA.py")
